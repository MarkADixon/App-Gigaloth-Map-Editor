...
namespace ParallaxEngine
{
    ...
    public class Layer
    {
        ...
        protected Vector2 layerParallax = new Vector2 ( 1f, 1f); //1.0f is no parallax, 0.0f for slower rate (farther back), above 1.0f creates faster scroll than camera (near lens)
